...
public class CadastroServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3307/Usuario", "root", "p@$$w0rd");
            String sql = "INSERT INTO Usuario (nome, sobrenome, data_nascimento, genero, nacionalidade, documento, telefone, email, senha) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
